...
const SettingsMenu = React.memo(() => {
  ...
  return (
    <div className="relative min-w-fit" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute top-full -right-52 mt-3 w-56 bg-white/95 backdrop-blur-md rounded-xl shadow-xl border border-white/20 py-3 animate-in fade-in slide-in-from-top-2 duration-200 z-50">
